"""
Neural audio-to-score alignment using CNN-based multipitch features.
...
a convolutional neural network (CNN). It is part of a broader
Music Information Retrieval (MIR) workflow for aligning monophonic
performances of baroque repertoire (e.g., Telemann Fantasias).
